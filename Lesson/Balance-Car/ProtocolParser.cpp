...
E_SMARTCAR_STATUS ProtocolParser::GetRobotDirection()
{
    if (recv->function == E_ROBOT_CONTROL_DIRECTION ) {
        return ((E_SMARTCAR_STATUS)(*(recv->data)));
    } else {
        return (E_SMARTCAR_STATUS)0;
    }
}
